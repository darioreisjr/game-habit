...
export function HabitFormModal({ isOpen, habit, onClose, onSuccess }: HabitFormModalProps) {
  // Handle escape key
  useEffect(() => {
          ...
          >
            <Card className="p-6 shadow-xl">
              <div className="flex items-center justify-between mb-6">
                <h2 id="modal-title" className="text-2xl font-display font-semibold">
              ...
              <HabitForm habit={habit || undefined} onSuccess={handleSuccess} onCancel={onClose} />
            </Card>
          </motion.div>
        </motion.div>
      )}
